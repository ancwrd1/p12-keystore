...
pub const FRIENDLY_NAME_OID: ObjectIdentifier =
    ObjectIdentifier::new_unwrap("1.2.840.113549.1.9.20");
pub const LOCAL_KEY_ID_OID: ObjectIdentifier =
...
pub const CONTENT_TYPE_ENCRYPTED_DATA_OID: ObjectIdentifier =
...
pub const ORACLE_TRUSTED_KEY_USAGE_OID: ObjectIdentifier =
...
pub const CERT_TYPE_X509_CERTIFICATE_OID: ObjectIdentifier =
